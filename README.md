...
Бронирование товара.
Используются всеми магазинами. Изменения вносятся всем магазинами (есть конкуренция).

* GET reserve/list получить список всех броней
* GET reserve/get/019eeabb-19b7-7808-aa5f-49ce1e612b01  - проверить, что изделине забронировано
* POST reserve/book забронировать изделие по serialNumber
